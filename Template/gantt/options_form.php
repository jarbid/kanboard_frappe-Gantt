...
$labels = array(
    ...
    'lines' => t('Grid lines'),
    'left_column' => t('Show the task column beside the chart'),
    'left_column_width' => t('Task column width (pixels)'),
    'left_column_fields' => t('Extra fields in the task column'),
    ...
    'scroll_to' => t('Scroll to on load ("today", "fit", "start", "end" or a date)'),
