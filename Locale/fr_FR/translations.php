...
return array(
    ...
    'Add a predecessor' => 'Ajouter un prédécesseur',
    'Remove a dependency' => 'Supprimer une dépendance',
    'Click the task this one depends on' => 'Cliquez sur la tâche dont celle-ci dépend',
    'Cancel' => 'Annuler',
    'This task has no dependencies' => 'Cette tâche n\'a aucune dépendance',
    'Dependency saved' => 'Dépendance enregistrée',
    'Print' => 'Imprimer',
    'Download as PNG' => 'Télécharger en PNG',
    'Unable to produce the image' => 'Impossible de générer l\'image',
    'This would create a circular dependency' => 'Cela créerait une dépendance circulaire',
